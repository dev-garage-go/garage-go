...
import { CompanyWhatsappLink, MultiAgentWhatsAppLink } from '@/features/home';
  ...
  return (
    <>
      <a
        ...
        className="text-center px-4 py-2 md:px-8 md:py-3 text-sm md:text-base bg-primaryPink-500 text-white rounded-lg hover:bg-primaryPink-700 transition-colors duration-300">
        Agenda ahora
      </a>
      <a
        target="_blank"
